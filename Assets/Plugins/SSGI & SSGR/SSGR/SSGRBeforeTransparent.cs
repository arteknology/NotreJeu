...
[Serializable, VolumeComponentMenu("Lighting/SSGRBeforeTransparent")]
public class SSGRBeforeTransparent : CustomPostProcessVolumeComponent, IPostProcessComponent
{
    [Tooltip("Intensity")]
    ...
    {
        if (Shader.Find("Hidden/Shader/SSGRBeforeTransparent") != null) 
            m = new Material(Shader.Find("Hidden/Shader/SSGRBeforeTransparent"));
    }
