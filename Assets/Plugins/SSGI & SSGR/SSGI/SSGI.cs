...
[Serializable, VolumeComponentMenu("Lighting/SSGI")]
public class SSGI : CustomPostProcessVolumeComponent, IPostProcessComponent
{
    ...
    public override void Setup()
    {
        if (Shader.Find("Hidden/Shader/SSGI") != null) 
            m = new Material(Shader.Find("Hidden/Shader/SSGI"));
    }
